...
const DICT = {
  ...
  'ac.local':           ['الحسابات في مِداد محلية: تُحفظ في هذا المتصفح وحده، ولا تُرسل إلى أي خادم. كلمة المرور تفصل الرفوف بين القرّاء على هذا الجهاز، ولا تحمي البيانات ممّن يستطيع فتح المتصفح.',
                         'MIDĀD accounts are local: they live in this browser alone and are sent to no server. The password separates one reader’s shelves from another’s on this device; it does not protect the data from anyone who can open the browser.'],
